      ...
      <div id="statement">
        <Card className={classes.card}>
          <CardContent>
            ...
            <Typography component="p">
              The statement of faith that follows is designed to set forth the
              primary doctrines of our faith. It is not an exhaustive account of
              our beliefs. The Bible itself, as the inspired and infallible Word
              of God that speaks with final authority concerning truth,
              morality, and the proper conduct of mankind, is the final and
              supremely authoritative source of all that we believe. For
              purposes of Christ Fellowship Church’s practice, policies, and
              discipline, the elders of the church, under the authority of the
              whole congregation, are Christ Fellowship Church’s final human
              interpretive authority on the Bible’s meaning and application
              within the guidelines of the statement of faith.
            </Typography>
          </CardContent>
        </Card>
        <Card className={classes.card}>
          <CardContent>
            ...
            <Typography component="p">
              The 66 books of the Old and New Testaments, commonly known as the
              Holy Bible, are the Word of God, given by the inspiration of God
              and are the only sufficient, certain, and authoritative rule of
              all saving knowledge, faith, and practice. The Holy Bible was
              written by men divinely inspired and is God's revelation of
              Himself to man. It is a perfect treasure of divine instruction. It
              has God for its author, salvation for its end, and truth, without
              any mixture of error, for its matter. Therefore, all Scripture is
              ...
              opinions should be tried. All Scripture is a testimony to Christ,
        ...
        <Card className={classes.card}>
          <CardContent>
            ...
            <Typography component="p">
              ...
              eternal triune God has always, and will always, exist as Father,
              Son, and Holy Spirit, with distinct personal relations, but
            ...
            <Typography component="p">
              ...
              creatures, and human history according to the purposes of His
              grace. He is all-powerful, all-knowing, all-loving, and all wise.
              He is, from eternity, the Father of the Son, and through his
              redemptive plan becomes Father in truth to those who become
            ...
            <Typography component="p">
              ...
              substitutionary death on the cross He atoned for the sin of all
              who will believe. He was raised from the dead with a glorified
              body and appeared to His disciples as the person who was with them
              before His crucifixion. He ascended into heaven and is now exalted
              at the right hand of God where He is the One Mediator – fully God,
              fully man – in whose Person is effected the reconciliation between
              God and man. He will return in power and glory to judge the world
            ...
            <Typography component="p">
              ...
              Savior, and effects regeneration. He cultivates Christian
              character, comforts believers, and bestows the spiritual gifts by
              which they serve God through His church. He seals the believer
              unto the day of final redemption. His presence in the Christian is
              the guarantee that God will bring the believer into the fullness
              of the stature of Christ. He enlightens and empowers the believer
        ...
        <Card className={classes.card}>
          <CardContent>
            ...
            <Typography component="p">
              ...
              The gift of gender, which cannot be severed from biological sex,
              is thus part of the goodness of God's creation. Therefore,
              rejection of one’s biological sex constitutes a rejection of God’s
              design for one’s good. Marriage is the uniting of one man and one
              ...
              provide the man and the woman in marriage the framework for
              ...
              defined above is a rejection of God’s good and gracious gifts to
              his creation and is thus regarded as sinful.
            </Typography>
            <Divider className={classes.spacer} />
            <Typography component="p">
              ...
              from his original innocence whereby all born from Adam inherit an
              utterly sinful nature. Only the grace of God can bring man into
              His holy fellowship and enable man to fulfill the creative purpose
              of God. The sanctity of human life is evident in the fact that God
              created man in His own image; therefore, every person of every
              race and age (from conception to death) possesses full dignity and
        ...
        <Card className={classes.card}>
          <CardContent>
            ...
            <Typography component="p">
              Salvation involves the redemption of the whole man, and is applied
              to all who repent of their sins and believe in Jesus Christ as
              Lord and Savior, who by His own blood obtained eternal redemption
            ...
            <Typography component="p">
              ...
              heart wrought by the Holy Spirit through conviction of sin, to
              which the sinner responds in repentance toward God and faith in
            ...
            <Typography component="p">
              ...
              Christ. It includes the pardon of sin and the promise of eternal
              life, which are not bestowed because of any righteous works which
              the believer has done but solely through faith by which Christ’s
              perfect righteousness is freely imputed to the believer by God.
              Justification brings the believer into a relationship of peace and
              favor with God.
            </Typography>
            <Divider className={classes.spacer} />
            <Typography
            ...
            <Typography component="p">
              ...
              which the believer is set apart to God's purposes, and is enabled
              to progress toward moral and spiritual maturity through the
            ...
            <Typography component="p">
              ...
              glorification, being achieved only after this life, the believer
              will be perfectly righteous, like his Lord. Thus, he will dwell
              with his Creator and Lord for all eternity.
            </Typography>
          </CardContent>
        </Card>
        <Card className={classes.card}>
          <CardContent>
            ...
            <Typography component="p">
              ...
              unchangeable. It excludes boasting and promotes humility. All true
              ...
              salvation. Those who profess faith but do not persevere, thereby
              show themselves to be unregenerate.
            </Typography>
          </CardContent>
        </Card>
        <Card className={classes.card}>
          <CardContent>
            ...
            <Typography component="p">
              ...
              to extend the gospel to the ends of the earth. Its scriptural
              officers are elders and deacons. While both men and women are
              gifted for service in the church, the office of elder is limited
              to men as qualified by Scripture. The New Testament speaks also of
        ...
        <Card className={classes.card}>
          <CardContent>
            ...
            <Typography component="p">
              Christian baptism, being the believer’s profession of faith, is an
              act of obedience symbolizing the believer's faith in a crucified,
              buried, and risen Savior, the believer's cleansing from sin and
              death to sin, the burial of the old life, and the resurrection to
              walk in newness of life in Christ Jesus. It is to be done by
              immersion in water in the name of the Father, the Son, and the
              Holy Spirit. Being a church ordinance, it is prerequisite to the
              privileges of church membership. The Lord's Supper is a symbolic
              act of obedience whereby members of the church, through partaking
              of the bread and the cup, remember the death of the Redeemer and
        ...
        <Card className={classes.card}>
          <CardContent>
            ...
            <Typography component="p">
              ...
              punishment. The righteous in their resurrected and glorified
